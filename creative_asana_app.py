...
async function renderDashboard() {
  ...
  function renderEstProj() {
    ...
    if (drill) {
      ...
      backBar = `<div class="toolbar drill-head"><button class="btn" id="est-drill-back">← Back to all projects</button>` +
                `<span class="tb-label">${esc(drill.name)} · split by project</span></div>`;
    } else {
  ...
  function renderActualProj() {
    ...
    if (drill) {
      ...
      backBar = `<div class="toolbar drill-head"><button class="btn" id="actual-drill-back">← Back to all projects</button>` +
                `<span class="tb-label">${esc(drill.name)} · split by project</span></div>`;
    } else {
